...
/** Struct Functor used to calculate the sum of multiple Positions */
struct Sum {

	Position positionsSum = Position(0.0, 0.0);

	/**
	* Operator Overide of () used to add pass position to positionsSum
	* 
	* @param next - the next Position to be added to positionsSum
	*/
...
public:
	...
	*/
	...
	/**
	* Checks if User instance has been exposed to any Users in the database
	*  that are infected/contagious
	*
	* @returns the number of exposures found
	*/
	int CheckExposures();
