...
public:
     ...
     * @param x - is a flaot representing the x coordinate of this Locations position
     * @param y - is a float representing the y coordinate fo this Locations position
     * @param reservations is the amount of reservations available
     */
    ...
    *  between this Location a passed Position
    *
    ...
    */
    ...
    /** 
    * Getter function for Locations Position
    * 
    * @returns the Position of this Location instance
    */
